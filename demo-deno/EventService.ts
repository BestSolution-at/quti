...
import type { EventNew } from './model/EventNew.ts';
import type { Result, VoidType } from './_result-utils.ts';
import type { InvalidArgumentError, NativeRSDError, NotFoundError, StatusRSDError } from './Errors.ts';
import type { Event, EventPatch } from './model/Event.ts';
import type { EventSearch } from './model/EventSearch.ts';
