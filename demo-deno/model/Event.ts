...
import { type EventRepeat, EventRepeatFromJSON, type EventRepeatPatch, EventRepeatToJSON, isEventRepeat } from './EventRepeat.ts';
import { checkOptProp, checkProp, createTypedArrayGuard, isBoolean, isNull, isRecord, isString, isUndefined, type ListMergeAddRemove, type ListReplace, propListValue, propMappedValue, propValue } from '../_type-utils.ts';
