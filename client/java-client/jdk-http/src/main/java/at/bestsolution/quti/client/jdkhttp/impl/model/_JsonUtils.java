...
public class _JsonUtils {
	...
	private static final Nillable<Boolean> NILLABLE_FALSE = _NillableImpl.of(Boolean.FALSE);
	private static final Nillable<Boolean> NILLABLE_TRUE = _NillableImpl.of(Boolean.TRUE);
