...
import { type EventRepeat, EventRepeatFromJSON, EventRepeatOrPatchFromJSON, EventRepeatOrPatchToJSON, type EventRepeatPatch, EventRepeatPatchFromJSON, EventRepeatPatchToJSON, EventRepeatToJSON, isEventRepeat, isEventRepeatPatch } from './EventRepeat.js';
import { checkOptProp, checkProp, createReplaceAddRemoveGuard, createTypedArrayGuard, isBoolean, isNull, isRecord, isString, isUndefined, type ListMergeAddRemove, ListMergeAddRemoveFromJSON, type ListReplace, noopMap, propListValue, propMappedValue, propValue } from '../_type-utils.js';
