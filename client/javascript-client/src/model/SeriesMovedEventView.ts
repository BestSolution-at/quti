...
export function isSeriesMovedEventView(
	value: unknown,
): value is SeriesMovedEventView {
	return (
		isRecord(value) &&
...
export function SeriesMovedEventViewFromJSON(
...
export function SeriesMovedEventViewToJSON(
	value: SeriesMovedEventView,
