...
export function isEventRepeatAbsoluteYearly(
	value: unknown,
): value is EventRepeatAbsoluteYearly {
	return (
		isRecord(value) &&
...
export function EventRepeatAbsoluteYearlyFromJSON(
...
export function EventRepeatAbsoluteYearlyToJSON(
	value: EventRepeatAbsoluteYearly,
...
export function isEventRepeatAbsoluteYearlyPatch(
	value: unknown,
): value is EventRepeatAbsoluteYearlyPatch {
	return (
		isRecord(value) &&
		checkProp(
			value,
			'@type',
			createIsStringTypeGuard('patch:absolute-yearly'),
		) &&
...
export function EventRepeatAbsoluteYearlyPatchFromJSON(
	value: Record<string, unknown>,
...
export function EventRepeatAbsoluteYearlyPatchToJSON(
	value: EventRepeatAbsoluteYearlyPatch,
): Record<string, unknown> {
	const dayOfMonth = value.dayOfMonth;
	const month = value.month;
	const interval = value.interval;
