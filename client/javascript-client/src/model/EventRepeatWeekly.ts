...
export function isEventRepeatWeekly(
	value: unknown,
): value is EventRepeatWeekly {
	return (
		isRecord(value) &&
...
export function EventRepeatWeeklyFromJSON(
...
export function EventRepeatWeeklyToJSON(
	value: EventRepeatWeekly,
...
export function isEventRepeatWeeklyPatch(
	value: unknown,
): value is EventRepeatWeeklyPatch {
	return (
		isRecord(value) &&
		checkProp(value, '@type', createIsStringTypeGuard('weekly')) &&
...
export function EventRepeatWeeklyPatchFromJSON(
	value: Record<string, unknown>,
...
export function EventRepeatWeeklyPatchToJSON(
	value: EventRepeatWeeklyPatch,
): Record<string, unknown> {
	const daysOfWeek = value.daysOfWeek;
	const interval = value.interval;
	const endDate = value.endDate;
