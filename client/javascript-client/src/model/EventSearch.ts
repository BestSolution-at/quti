...
export function EventSearchFromJSON(
	value: Record<string, unknown>,
): EventSearch {
	const tags = propListValue('tags', value, isString, 'optional');
	const startRange = propMappedValue(
		'startRange',
		value,
		isRecord,
		DateTimeRangeFromJSON,
	...
	const endRange = propMappedValue(
		'endRange',
		value,
		isRecord,
		DateTimeRangeFromJSON,
...
export function EventSearchToJSON(value: EventSearch): Record<string, unknown> {
	...
	const startRange = isUndefined(value.startRange)
		? undefined
		: DateTimeRangeToJSON(value.startRange);
	const endRange = isUndefined(value.endRange)
		? undefined
		: DateTimeRangeToJSON(value.endRange);
