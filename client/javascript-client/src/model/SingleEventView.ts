...
export function isSingleEventView_Status(value: unknown): value is StatusEnum {
...
export function SingleEventViewFromJSON($value: Record<string, unknown>): SingleEventView {
...
export function SingleEventViewToJSON($value: SingleEventView): Record<string, unknown> {
	const key = $value.key;
