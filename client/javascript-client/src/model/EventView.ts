...
import {
	isSingleEventView,
	type SingleEventView,
	SingleEventViewFromJSON,
	SingleEventViewToJSON,
} from './SingleEventView.js';
import {
	isSeriesMovedEventView,
	type SeriesMovedEventView,
	SeriesMovedEventViewFromJSON,
	SeriesMovedEventViewToJSON,
} from './SeriesMovedEventView.js';
import {
	isSeriesEventView,
	type SeriesEventView,
	SeriesEventViewFromJSON,
	SeriesEventViewToJSON,
} from './SeriesEventView.js';
...
export function isEventView(value: unknown) {
	return (
		isSingleEventView(value) ||
		isSeriesMovedEventView(value) ||
		isSeriesEventView(value)
	);
}
