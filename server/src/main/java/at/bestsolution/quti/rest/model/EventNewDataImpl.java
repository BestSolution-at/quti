...
public class EventNewDataImpl extends _BaseDataImpl implements EventNew.Data {
	EventNewDataImpl(JsonObject data) {
		super(data);
	}
	...
	public static EventNew.Data of(JsonObject obj) {
		return new EventNewDataImpl(obj);
	}
	...
	public static class DataBuilderImpl implements EventNew.DataBuilder {
		private JsonObjectBuilder $builder = Json.createObjectBuilder();

		public EventNew.DataBuilder title(String title) {
			if (title == null) {
				return this;
			}
		...
		public EventNew.DataBuilder description(String description) {
			if (description == null) {
				return this;
			}
		...
		public EventNew.DataBuilder start(ZonedDateTime start) {
			if (start == null) {
				return this;
			}
		...
		public EventNew.DataBuilder end(ZonedDateTime end) {
			if (end == null) {
				return this;
			}
		...
		public EventNew.DataBuilder fullday(boolean fullday) {
			$builder.add("fullday", fullday);
			return this;
		}

		public EventNew.DataBuilder repeat(EventRepeat.Data repeat) {
			if (repeat == null) {
				return this;
			}
		...
		public EventNew.DataBuilder tags(List<String> tags) {
			if (tags == null) {
				return this;
			}
		...
		public EventNew.DataBuilder referencedCalendars(List<String> referencedCalendars) {
		...
		public EventNew.Data build() {
			return new EventNewDataImpl($builder.build());
		}
	}

	public static EventNew.DataBuilder builder() {
