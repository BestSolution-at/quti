...
public class EventNewDTOImpl implements EventNewDTO {
    ...
    public static class BuilderImpl implements EventNewDTO.Builder {
        public String title;
        public String description;
        public ZonedDateTime start;
        public ZonedDateTime end;
        ...
        public EventNewDTO.Builder title(String title) {
            this.title = title;
            return this;
        }
        public EventNewDTO.Builder description(String description) {
            this.description = description;
            return this;
        }
        public EventNewDTO.Builder start(ZonedDateTime start) {
            this.start = start;
            return this;
        }
        public EventNewDTO.Builder end(ZonedDateTime end) {
            this.end = end;
            return this;
        }
        public EventNewDTO.Builder fullday(boolean fullday) {
            this.fullday = fullday;
            return this;
        }
        public EventNewDTO.Builder repeat(at.bestsolution.quti.service.dto.EventRepeatDTO repeat) {
            this.repeat = EventRepeatDTOImpl.of(repeat);
            return this;
        }
        public EventNewDTO.Builder tags(List<String> tags) {
            this.tags = tags;
            return this;
        }
        public EventNewDTO.Builder referencedCalendars(List<String> referencedCalendars) {
    ...
    public static EventNewDTO.Builder builder() {
