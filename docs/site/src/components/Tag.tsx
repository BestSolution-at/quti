...
const colorStyles = {
	...
	indigo: {
		small: 'text-indigo-400 dark:text-indigo-500',
		medium:
			'ring-indigo-200 bg-indigo-50 text-indigo-500 dark:ring-indigo-500/20 dark:bg-indigo-400/10 dark:text-indigo-400',
	},
}
