...
try {
	...
	// The server sent an undocumented Status Code for the API Call
	// or there was a technical error like a network problem
}
```

As you may have noted the Typescript/JavaScript API distinguish 2 error types:
- Documented domain errors
- Undocumented (technical) error

and forces you to handle at least the domain errors.
